...
![Claude Science 绿皮书 10 · 写成一篇论文](assets/day10/cs10-cover.png)
...
![七个部分对照实验报告：一格要整理、两格要转化、四格得手搓](assets/day10/fig01-seven-parts.png)
...
![写作顺序：从结果与讨论起笔，摘要留到最后](assets/day10/fig02-writing-order.png)
...
![六个版本的三维评分：完成度一格格爬，可复现跳着涨](assets/day10/fig03-bytes-line.png)
...
![一张图看完：实验报告和论文差在哪、按什么顺序写、到什么程度算写完](assets/day10/fig04-one-look.png)
