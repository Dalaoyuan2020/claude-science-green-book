# 任务：把绿皮书 Day 2 发布任务提炼成执行 Prompt
...
- 正文 HTML（已按公众号规范排版并校验通过）：
  `/Users/minilyu/Documents/Claude_Mini_agent/claude-science-green-book/gzh/day02/day02精华版_排版_摸鱼绿(moyu-green).html`
...
- 封面图（1:1 星空）：
  `/Users/minilyu/Documents/Claude_Mini_agent/claude-science-green-book/articles/assets/day02/img1-cover-csa.png`
...
- 原文链接（若编辑器支持）：`https://dalaoyuan2020.github.io/study-blog/reading/claude-science/02-run-it-on-windows`
...
4. 核对正文：图片是否全部转存成功（4 张配图＋封面卡小图）；排版是否与预览页一致；若个别图裂了，从本机对应 PNG 手动上传替换（图片源文件都在 `claude-science-green-book/articles/assets/day02/`）
