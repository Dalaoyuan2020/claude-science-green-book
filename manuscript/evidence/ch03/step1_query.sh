...
curl -s "https://api.openalex.org/works?search=lightweight%20industrial%20anomaly%20detection&filter=publication_year:2021-2026&sort=cited_by_count:desc&per-page=50&select=id,title,publication_year,cited_by_count,primary_location,type,keywords,concepts&mailto=Sunshinethh@groupmail.com" \
